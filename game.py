...
class MyMainWindow(QMainWindow,Ui_Form):
    ...
    # The new_game method resets the game state for a new game, handling AI moves and updating the GUI accordingly.
    # It also checks if both players are AI-controlled, and if so, triggers a new game.
    def new_game(self):
